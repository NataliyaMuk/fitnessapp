  ...
  return (
    <View style={styles.container}>
      {isInputVisible && (
        <>
          ...
          <TextInput
            ...
            onChangeText={(text) =>
              setUserDetails({ ...userDetails, age: parseInt(text) || 0 })
            }
          ...
          <TextInput
            ...
            onChangeText={(text) =>
              setUserDetails({ ...userDetails, weight: parseInt(text) || 0 })
            }
            keyboardType="numeric"
          />
          <TextInput
          ...
          <TextInput
            ...
            onChangeText={(text) =>
              setUserDetails({
                ...userDetails,
                musclePercentage: parseInt(text) || 0,
              })
            }
            keyboardType="numeric"
          />
      ...
      <Svg
        ...
        <Path
          d="M13.4065 50.6933C15.4445 45.9364 16.7105 44.0091 23.1218 39.7672C24.8341 35.0558 28.0827 32.4635 30.8582 30.2879C32.166 25.091 32.3455 19.5524 31.3302 17.3054C31.0721 18.7632 29.0513 20.5836 26.6225 21.8497C27.6685 24.3387 29.4889 26.5967 31.4384 27.5616"
          stroke="#0FA958"
      ...
      {!isInputVisible && (
        <>
          ...
          <Text style={styles.userDetail}>
            Желаемый вес: {userDetails.targetWeight} кг
          </Text>
          <Text style={styles.userDetail}>
            Процент жира: {userDetails.fatPercentage}%
          </Text>
          <Text style={styles.userDetail}>
            Процент мышц: {userDetails.musclePercentage}%
          </Text>
          ...
          <Modal
            ...
            <View style={styles.modalContainer}>
              <View style={styles.modalContent}>
                <Text>
                  Триумф не дарует настоящей силы, её формирует борьба. (Арнольд
                  Шварценеггер)
                </Text>
